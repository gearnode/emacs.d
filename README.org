...
** Git
Emacs version control seems nice, but too does not wrap Git as Magit
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq gnus-secondary-select-methods
        '((nntp "news.gwene.org")
          ...
          (nnimap "exograd"
                  (nnimap-address "imap.gmail.com")
                  (nnimap-server-port 993)
                  (nnimap-stream-ssl 993)
                  (nnir-search-engine imap)
                  (signature "Bryan Frimin\n\
                              https://www.exograd.com\
  ...
  (setq gnus-message-archive-method '(nnimap "imap.frimin.fr"))
